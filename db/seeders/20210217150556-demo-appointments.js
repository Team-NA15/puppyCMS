   ...
   await queryInterface.bulkInsert('Appointments', [
    {
      ...
      breed:'Yorkie',
      service: 'Grooming',
      arrival_date: new Date(2021,3,25,8,0,0),
      depart_date: new Date(2021,3,25,14,30,0),
      cubby: 10,
      breakfast: true,
    ...
    },
    {
      ...
      breed:'Great Dane',
      service: 'Grooming',
      arrival_date: new Date(2021,3,25,16,0,0),
      depart_date: new Date(2021,3,25,17,30,0), 
