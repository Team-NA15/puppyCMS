   ...
   await queryInterface.bulkInsert('Appointments', [
    {
      ...
      breed:'Yorkie',
      service: 'Grooming',
      arrival_date: new Date(2021,3,23,8,0,0),
      depart_date: new Date(2021,3,23,14,30,0),
      cubby: 10,
      breakfast: true,
    ...
    },
    {
      ...
      breed:'Great Dane',
      service: 'Grooming',
      arrival_date: new Date(2021,3,23,16,0,0),
      depart_date: new Date(2021,3,23,17,30,0), 
