   ...
   await queryInterface.bulkInsert('Appointments', [
    {
      ...
      breed:'Yorkie',
      service: 'Grooming',
      arrival_date: new Date(2021,3,22,8,0,0),
      depart_date: new Date(2021,3,22,14,30,0),
      cubby: 10,
      breakfast: true,
    ...
    },
    {
      ...
      depart_date: new Date(2021,3,30,17,30,0),
      cubby: 63,
    ...
    },
    {
      ...
      breed:'Great Dane',
      service: 'Grooming',
      arrival_date: new Date(2021,3,22,16,0,0),
      depart_date: new Date(2021,3,22,17,30,0), 
