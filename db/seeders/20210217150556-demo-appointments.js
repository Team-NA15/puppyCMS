   ...
   await queryInterface.bulkInsert('Appointments', [
    {
      ...
      service: 'Grooming',
      arrival_date: new Date(2021,3,30,8,0,0),
      depart_date: new Date(2021,3,30,14,30,0),
      cubby: 10,
      breakfast: true,
    ...
    },
    {
      ...
      service: 'Boarding',
      arrival_date: new Date(2021,3,30,8,0,0),
      depart_date: new Date(2021,5,30,14,30,0),
      cubby: 18,
      breakfast: true,
      breakfast_quant: "1 bag",
      lunch: true, 
    ...
    },
    {
      ...
      service: 'Daycare',
      arrival_date: new Date(2021,3,15,9,0,0),
      depart_date: new Date(2021,3,15,17,30,0),
      cubby: 69,
    ...
    },
    {
      ...
      breed: dogs[0][3].breed,
      service: 'Daycare',
      arrival_date: new Date(2021,3,18,9,0,0),
      depart_date: new Date(2021,3,18,17,30,0),
      cubby: 71,
      belongings:"pokemon collar",
      breakfast: true,
      breakfast_quant: "2 bags",
    ...
    },
    {
      ...
      breed: dogs[0][3].breed,
      service: 'Boarding',
      arrival_date: new Date(2021,3,20,9,0,0),
    ...
    },
    {
      ...
      service: 'Grooming',
      arrival_date: new Date(2021,3,29,9,0,0),
      depart_date: new Date(2021,3,29,17,30,0), 
